...
@Order(3)
public class HttpErrorHandler extends BaseApiErrorHandler {

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<Map<String, Object>> handleMalformed(HttpMessageNotReadableException e){
        Map<String, Object> body = httpMap(1, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<Map<String, Object>> handleMediaTypeNotSupported(HttpMediaTypeNotSupportedException e){
        Map<String, Object> body = httpMap(2, HttpStatus.UNSUPPORTED_MEDIA_TYPE);
    ...
    public ResponseEntity<Map<String, Object>> handleNotSupportedMethods(HttpRequestMethodNotSupportedException e){
        Map<String, Object> body = httpMap(2, HttpStatus.METHOD_NOT_ALLOWED);
        body.put("message", e.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleTypeMismatch(MethodArgumentTypeMismatchException e){
        Map<String, Object> body = httpMap(4, HttpStatus.BAD_REQUEST);
        body.put("message", e.getMessage());
